...
public class AdminService {
	...
	public Boolean updateBike(int id, String model, String engineCc, int mileage, String fuelType, double price,
			String rentType, String available) {
		return dao.updateBike(id,model,engineCc,mileage,fuelType,price,rentType,available);
	}
